...
namespace Lookif.Layers.WebFramework.Swagger
{
    public static class SwaggerConfigurationExtensions
    {
        public static void AddSwagger(this IServiceCollection services)
        {
            ...
            {
               // var xmlDocPath = Path.Combine(AppContext.BaseDirectory, "Lookif.Layers.xml");
                ...
                options.AddSecurityDefinition("OAuth2", new OpenApiSecurityScheme
                {
                    ...
                    Flows = new OpenApiOAuthFlows
                    {
                        Password = new OpenApiOAuthFlow
                        {
                            ...
                            //{
                            //    { "readAccLookif.Layers", "AccLookif.Layers read operations" },
                            //    { "writeAccLookif.Layers", "AccLookif.Layers write operations" }
                            //}
                        }
                    }
                });
